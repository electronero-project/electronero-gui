...
void TransactionHistorySortFilterModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TransactionHistorySortFilterModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransactionHistorySortFilterModel::searchFilterChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TransactionHistorySortFilterModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransactionHistorySortFilterModel::paymentIdFilterChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TransactionHistorySortFilterModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransactionHistorySortFilterModel::dateFromFilterChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (TransactionHistorySortFilterModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransactionHistorySortFilterModel::dateToFilterChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (TransactionHistorySortFilterModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransactionHistorySortFilterModel::amountFromFilterChanged)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (TransactionHistorySortFilterModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransactionHistorySortFilterModel::amountToFilterChanged)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (TransactionHistorySortFilterModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransactionHistorySortFilterModel::directionFilterChanged)) {
                *result = 6;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TransactionHistorySortFilterModel::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_TransactionHistorySortFilterModel.data,
      qt_meta_data_TransactionHistorySortFilterModel,  qt_static_metacall, nullptr, nullptr}
};
