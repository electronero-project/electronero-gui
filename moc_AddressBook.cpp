...
void AddressBook::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { QList<Monero::AddressBookRow*> _r = _t->getAll((*reinterpret_cast< bool(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QList<Monero::AddressBookRow*>*>(_a[0]) = std::move(_r); }  break;
        case 3: { QList<Monero::AddressBookRow*> _r = _t->getAll();
            if (_a[0]) *reinterpret_cast< QList<Monero::AddressBookRow*>*>(_a[0]) = std::move(_r); }  break;
        case 4: { Monero::AddressBookRow* _r = _t->getRow((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< Monero::AddressBookRow**>(_a[0]) = std::move(_r); }  break;
        ...
        {
            using _t = void (AddressBook::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddressBook::refreshStarted)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AddressBook::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddressBook::refreshFinished)) {
                *result = 1;
                return;
            }
        }
...
{
    QMetaObject::activate(const_cast< AddressBook *>(this), &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void AddressBook::refreshFinished()const
{
    QMetaObject::activate(const_cast< AddressBook *>(this), &staticMetaObject, 1, nullptr);
}
QT_WARNING_POP
