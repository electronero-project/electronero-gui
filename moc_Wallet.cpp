...
void Wallet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Wallet::*)(const QString & , quint64 );
        ...
        {
            using _t = void (Wallet::*)(quint64 , quint64 );
        ...
        {
            using _t = void (Wallet::*)(PendingTransaction * , QString , QString , quint32 );
        ...
        {
            using _t = void (Wallet::*)(ConnectionStatus ) const;
