...
QT_MOC_LITERAL(11, 158, 12), // "accountIndex"
QT_MOC_LITERAL(12, 171, 7), // "refresh"
QT_MOC_LITERAL(13, 179, 5), // "count"
QT_MOC_LITERAL(14, 185, 13), // "firstDateTime"
QT_MOC_LITERAL(15, 199, 12), // "lastDateTime"
QT_MOC_LITERAL(16, 212, 15), // "minutesToUnlock"
QT_MOC_LITERAL(17, 228, 6) // "locked"
    ...
    "QList<TransactionInfo*>\0accountIndex\0"
    "refresh\0count\0firstDateTime\0lastDateTime\0"
    "minutesToUnlock\0locked"
};
...
void TransactionHistory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: { TransactionInfo* _r = _t->transaction((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< TransactionInfo**>(_a[0]) = std::move(_r); }  break;
        case 5: { QList<TransactionInfo*> _r = _t->getAll((*reinterpret_cast< quint32(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QList<TransactionInfo*>*>(_a[0]) = std::move(_r); }  break;
        case 6: _t->refresh((*reinterpret_cast< quint32(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TransactionHistory::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransactionHistory::refreshStarted)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TransactionHistory::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransactionHistory::refreshFinished)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TransactionHistory::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransactionHistory::firstDateTimeChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (TransactionHistory::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransactionHistory::lastDateTimeChanged)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TransactionHistory::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TransactionHistory.data,
      qt_meta_data_TransactionHistory,  qt_static_metacall, nullptr, nullptr}
};
...
{
    QMetaObject::activate(const_cast< TransactionHistory *>(this), &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void TransactionHistory::refreshFinished()const
{
    QMetaObject::activate(const_cast< TransactionHistory *>(this), &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void TransactionHistory::firstDateTimeChanged()const
{
    QMetaObject::activate(const_cast< TransactionHistory *>(this), &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void TransactionHistory::lastDateTimeChanged()const
{
    QMetaObject::activate(const_cast< TransactionHistory *>(this), &staticMetaObject, 3, nullptr);
}
QT_WARNING_POP
