...
void filter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (filter::*)(const QVariant & , const QVariant & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&filter::sequencePressed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (filter::*)(const QVariant & , const QVariant & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&filter::sequenceReleased)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (filter::*)(const QVariant & , const QVariant & , const QVariant & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&filter::mousePressed)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (filter::*)(const QVariant & , const QVariant & , const QVariant & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&filter::mouseReleased)) {
                *result = 3;
                return;
            }
        }
